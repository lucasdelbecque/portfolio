(function () {
  ...
  var t = {
    fr: {
      ...
      'p05.num':  'Projet 05', 'p05.desc': "Trailer de révélation pour une <strong>Soirée de fin de semestre</strong> (NASA) sur le thème soirée pyjama. Conçu dans Unreal Engine et monté sous DaVinci Resolve — couleurs rétro NASA, effets cinématiques et bande-son pour une révélation mémorable.",
    ...
    en: {
      ...
      'p05.num':  'Project 05', 'p05.desc': 'Reveal trailer for a <strong>semester-end event</strong> (NASA) with a pyjama party theme. Designed in Unreal Engine and edited in DaVinci Resolve — retro NASA colours, cinematic effects and a soundtrack for an unforgettable reveal.',
